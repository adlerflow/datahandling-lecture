...
- Guest lecture: 
  ...
  - learn about open time series, 
  - experience what it is like to work as an Econ/Data Science right after your Bachelor's degree


## Updates

- Exam for exchange students: 19.12.2024 at 16:15 in room 01-207.
- Mock exam available in the break
- Reading list will be updated in the break
...
- Since 1998
- Real life examples:
  - Microsoft Office uses the XML-based file formats, such as .docx, .xlsx, and .pptx. See a XML representation of a Word document on https://en.wikipedia.org/wiki/Microsoft_Office_XML_formats
...
orders <- xml_children(xml_children(xml_doc))
orders
```
